...
var receiveAllPokemon = exports.receiveAllPokemon = function receiveAllPokemon(pokemons) {
  return {
...
var configureStore = function configureStore() {
  return (0, _redux.createStore)(_root_reducer.rootReducer, (0, _redux.applyMiddleware)(_reduxLogger.logger));
};
...
var _items_reducer = __webpack_require__(56);
...
var pokemonReducer = function pokemonReducer() {
  ...
  switch (action.type) {
    ...
    case _pokemon_actions.RECEIVE_ALL_POKEMON:
      var pokemons = action.pokemons;
      return (0, _merge.merge)({}, state, { pokemons: pokemons });
    default:
      return state;
  }
};
